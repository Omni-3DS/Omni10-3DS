...
OMNI_VER := $(shell tr -d ' \t\r\n' < version.dat 2>/dev/null || echo 0.9.1)
...
$(A9_BIN): $(A9_START) $(A9_SRC) $(A9_LD) version.dat
	@echo "=== ARM9 v$(OMNI_VER) ==="
	@$(RM) $(A9_ELF) $(A9_BIN)
	$(CC) $(A9_CFLAGS) $(ASFLAGS9) -T $(A9_LD) -nostdlib -Wl,--nmagic \
		$(A9_START) $(A9_SRC) -o $(A9_ELF)
...
$(TARGET): $(A9_BIN) $(A11_BIN)
	@echo "=== pack Omni10.firm v$(OMNI_VER) (ARM9+ARM11) ==="
	@$(RM) $(TARGET)
	...
	@echo "[OK] $(TARGET) dual-core v$(OMNI_VER)"
